...
create table "ACCOUNT" ("ID" SERIAL NOT NULL PRIMARY KEY,"FIRST_NAME" VARCHAR(254) NOT NULL,"LAST_NAME" VARCHAR(254) NOT NULL,"ADDRESS" VARCHAR(254) DEFAULT '' NOT NULL,"EMAIL" VARCHAR(254) DEFAULT '' NOT NULL,"PASSWORD" VARCHAR(254) NOT NULL,"ROLE" INTEGER NOT NULL,"SCORE" DOUBLE PRECISION DEFAULT 0.0 NOT NULL);
